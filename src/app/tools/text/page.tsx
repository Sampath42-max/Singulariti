...
export const metadata = {
  title: 'Text Tools — Convert, Count & Format Text Online | Singulariti',
  description: 'Free browser-based text utilities. Count words/chars, convert cases, compare lists, remove duplicates, generate lorem ipsum placeholder text, and reverse text instantly.',
};
